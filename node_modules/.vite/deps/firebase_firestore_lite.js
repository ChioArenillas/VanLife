...
// node_modules/@firebase/firestore/dist/lite/common-0a3137f7.esm.js
var User = class {
  constructor(e) {
    this.uid = e;
  }
  ...
  switch (r) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(e2, t2) {
        const r2 = e2.fields || {}, n2 = t2.fields || {}, i = r2[N]?.arrayValue, s = n2[N]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
        if (0 !== o) return o;
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(e) {
    const t = e.fields?.[N].arrayValue?.values?.map(((e2) => __PRIVATE_normalizeNumber(e2.doubleValue)));
