import { A as getModularInstance, C as LogLevel, D as createMockUserToken, E as FirebaseError, M as pingServer, O as deepEqual, T as Component, c as _getProvider, f as _registerComponent, g as getApp, j as isCloudWorkstation, k as getDefaultEmulatorHostnameAndPort, n as SDK_VERSION, p as _removeServiceInstance, u as _isFirebaseServerApp, w as Logger, x as registerVersion } from "./index.esm-CwL5aWi6.js";
...
//#endregion
//#region node_modules/@firebase/firestore/dist/lite/common-0a3137f7.esm.js
/**
* @license
...
/** Credential provider for the Lite SDK. */ var __PRIVATE_LiteAuthCredentialsProvider = class {
	constructor(e) {
	...
	getToken() {
		return this.auth ? this.auth.getToken().then(((e) => e ? (__PRIVATE_hardAssert("string" == typeof e.accessToken, 42297, { t: e }), new __PRIVATE_OAuthToken(e.accessToken, new User(this.auth.getUid()))) : null)) : Promise.resolve(null);
	}
	invalidateToken() {}
	start(e, t) {}
	shutdown() {}
...
/** AppCheck token provider for the Lite SDK. */ var __PRIVATE_LiteAppCheckTokenProvider = class {
	constructor(e, t) {
		this.m = t, this.appCheck = null, this.P = null, _isFirebaseServerApp(e) && e.settings.appCheckToken && (this.P = e.settings.appCheckToken), t.onInit(((e) => {
			this.appCheck = e;
		}));
	}
	getToken() {
		return this.P ? Promise.resolve(new AppCheckToken(this.P)) : this.appCheck ? this.appCheck.getToken().then(((e) => e ? (__PRIVATE_hardAssert("string" == typeof e.token, 3470, { tokenResult: e }), new AppCheckToken(e.token)) : null)) : Promise.resolve(null);
	}
	invalidateToken() {}
	start(e, t) {}
	shutdown() {}
...
/** The default database name for a project. */ var m = "(default)";
/**
...
function __PRIVATE_isPermanentError(e) {
	switch (e) {
		...
		case E.INTERNAL:
		case E.UNAVAILABLE:
		case E.UNAUTHENTICATED: return !1;
...
var g = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		...
		return new Timestamp(t, Math.floor((e - 1e3 * t) * v));
	}
	/**
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var b = "__type__", D = "__max__", S = { fields: { __type__: { stringValue: D } } }, C = "__vector__", N = "value";
...
function __PRIVATE_typeOrder(e) {
	return "nullValue" in e ? 0 : "booleanValue" in e ? 1 : "integerValue" in e || "doubleValue" in e ? 2 : "timestampValue" in e ? 3 : "stringValue" in e ? 5 : "bytesValue" in e ? 6 : "referenceValue" in e ? 7 : "geoPointValue" in e ? 8 : "arrayValue" in e ? 9 : "mapValue" in e ? __PRIVATE_isServerTimestamp(e) ? 4 : function __PRIVATE_isMaxValue(e) {
		...
		return (e?.mapValue?.fields || {})[b]?.stringValue === C;
...
function __PRIVATE_boundEquals(e, t) {
	...
	for (let r = 0; r < e.position.length; r++) if (!__PRIVATE_valueEquals(e.position[r], t.position[r])) return !1;
	return !0;
}
/**
* @license
...
function __PRIVATE_filterEquals(e, t) {
	return e instanceof FieldFilter ? function __PRIVATE_fieldFilterEquals(e, t) {
		...
		if (t instanceof CompositeFilter && e.op === t.op && e.filters.length === t.filters.length) return e.filters.reduce(((e, r, n) => e && __PRIVATE_filterEquals(r, t.filters[n])), !0);
		return !1;
	}(e, t) : void fail(19439);
}
...
/** Transforms a value into a server-generated timestamp. */ var __PRIVATE_ServerTimestampTransform = class extends TransformOperation {};
...
function __PRIVATE_fromBatchGetDocumentsResponse(e, t) {
	return "found" in t ? function __PRIVATE_fromFound(e, t) {
		...
		const r = fromName(e, t.found.name), n = __PRIVATE_fromVersion(t.found.updateTime), i = t.found.createTime ? __PRIVATE_fromVersion(t.found.createTime) : SnapshotVersion.min(), s = new ObjectValue({ mapValue: { fields: t.found.fields } });
...
function toMutation(e, t) {
	let r;
	if (t instanceof __PRIVATE_SetMutation) r = { update: __PRIVATE_toMutationDocument(e, t.key, t.value) };
	else if (t instanceof __PRIVATE_DeleteMutation) r = { delete: __PRIVATE_toName(e, t.key) };
	else if (t instanceof __PRIVATE_PatchMutation) r = {
		update: __PRIVATE_toMutationDocument(e, t.key, t.data),
		updateMask: __PRIVATE_toDocumentMask(t.fieldMask)
	};
	else {
		if (!(t instanceof __PRIVATE_VerifyMutation)) return fail(16599, { U: t.type });
		r = { verify: __PRIVATE_toName(e, t.key) };
	}
...
function __PRIVATE_toQueryTarget(e, t) {
	const r = { structuredQuery: {} }, n = t.path;
	let i;
	null !== t.collectionGroup ? (i = n, r.structuredQuery.from = [{
		collectionId: t.collectionGroup,
		allDescendants: !0
	}]) : (i = n.popLast(), r.structuredQuery.from = [{ collectionId: n.lastSegment() }]), r.parent = function __PRIVATE_toQueryPath(e, t) {
...
async function __PRIVATE_invokeCommitRpc(e, t) {
	const r = __PRIVATE_debugCast(e), n = { writes: t.map(((e) => toMutation(r.serializer, e))) };
	await r.I("Commit", r.serializer.databaseId, ResourcePath.emptyPath(), n);
}
async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
	const r = __PRIVATE_debugCast(e), n = { documents: t.map(((e) => __PRIVATE_toName(r.serializer, e))) }, i = await r.D("BatchGetDocuments", r.serializer.databaseId, ResourcePath.emptyPath(), n, t.length), s = /* @__PURE__ */ new Map();
	i.forEach(((e) => {
...
async function __PRIVATE_invokeRunQueryRpc(e, t) {
	...
	return (await r.D("RunQuery", r.serializer.databaseId, i, { structuredQuery: n.structuredQuery })).filter(((e) => !!e.document)).map(((e) => function __PRIVATE_fromDocument(e, t, r) {
		const n = fromName(e, t.name), i = __PRIVATE_fromVersion(t.updateTime), s = t.createTime ? __PRIVATE_fromVersion(t.createTime) : SnapshotVersion.min(), o = new ObjectValue({ mapValue: { fields: t.fields } }), a = MutableDocument.newFoundDocument(n, i, s, o);
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, r) {
	const n = __PRIVATE_debugCast(e), { request: i, K: s, parent: o } = function __PRIVATE_toRunAggregationQueryRequest(e, t, r, n) {
		...
		const t = __PRIVATE_debugCast(e);
		return t.B || (t.B = __PRIVATE__queryToTarget(t, e.explicitOrderBy)), t.B;
	}(t), r);
	n.connection.T || delete i.parent;
	const a = (await n.D("RunAggregationQuery", n.serializer.databaseId, o, i, 1)).filter(((e) => !!e.result));
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var B = "ComponentProvider", $ = /* @__PURE__ */ new Map();
/**
...
*/ var Q = 1048576, U = "firestore.googleapis.com", M = !0;
/**
...
function getFirestore(e, t) {
	const n = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : t || "(default)", s = _getProvider(n, "firestore/lite").getImmediate({ identifier: i });
	if (!s._initialized) {
...
*/ function connectFirestoreEmulator(e, r, o, a = {}) {
	...
	if (!deepEqual(h, c) && (e._setSettings(h), a.mockUserToken)) {
		let t, r;
		if ("string" == typeof a.mockUserToken) t = a.mockUserToken, r = User.MOCK_USER;
		else {
...
function collection(e, t, ...r) {
	if (e = getModularInstance(e), __PRIVATE_validateNonEmptyArgument("collection", "path", t), e instanceof Firestore) {
		...
		return __PRIVATE_validateCollectionPath(n), new CollectionReference(e, null, n);
	}
	{
		...
		return __PRIVATE_validateCollectionPath(n), new CollectionReference(e.firestore, null, n);
	}
}
/**
...
/** A "context" object passed around while parsing user data. */ var __PRIVATE_ParseContextImpl = class __PRIVATE_ParseContextImpl {
	...
	*/
	constructor(e, t, r, n, i, s) {
		this.settings = e, this.databaseId = t, this.serializer = r, this.ignoreUndefinedProperties = n, void 0 === i && this.G(), this.fieldTransforms = i || [], this.fieldMask = s || [];
	}
	get path() {
...
/** Parse document data from a set() call. */ function __PRIVATE_parseSetData(e, t, r, n, i, s = {}) {
	const o = e.ue(s.merge || s.mergeFields ? 2 : 0, t, r, i);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), n = new __PRIVATE_ArrayUnionTransformOperation(this.te.map(((e) => __PRIVATE_parseData(e, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), n = new __PRIVATE_ArrayRemoveTransformOperation(this.te.map(((e) => __PRIVATE_parseData(e, t))));
		return new FieldTransform(e.path, n);
	}
	isEqual(e) {
...
/** Parse update data from an update() call. */ function __PRIVATE_parseUpdateData(e, t, r, n) {
	...
	forEach(n, ((e, n) => {
		...
		const _ = i.Y(u);
		if (n instanceof __PRIVATE_DeleteFieldValueImpl) s.push(u);
		else {
			const e = __PRIVATE_parseData(n, _);
			null != e && (s.push(u), a.set(u, e));
		}
	}));
	return new ParsedUpdateData(a, new FieldMask(s), i.fieldTransforms);
}
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
	const a = e.ue(1, t, r), u = [__PRIVATE_fieldPathFromArgument(t, n, r)], _ = [i];
	...
	for (let e = 0; e < s.length; e += 2) u.push(__PRIVATE_fieldPathFromArgument(t, s[e])), _.push(s[e + 1]);
	...
	for (let e = u.length - 1; e >= 0; --e) if (!__PRIVATE_fieldMaskContains(c, u[e])) {
		...
		const n = a.Y(t);
		if (r instanceof __PRIVATE_DeleteFieldValueImpl) c.push(t);
		else {
			const e = __PRIVATE_parseData(r, n);
			null != e && (c.push(t), l.set(t, e));
		}
	}
	return new ParsedUpdateData(l, new FieldMask(c), a.fieldTransforms);
}
/**
...
*/ function __PRIVATE_parseQueryValue(e, t, r, n = !1) {
	return __PRIVATE_parseData(r, e.ue(n ? 4 : 3, t));
}
/**
...
*/ function __PRIVATE_fieldPathFromArgument(e, t, r) {
	...
	throw __PRIVATE_createError("Field path arguments must be of type string or ", e, !1, void 0, r);
}
/**
* Matches any characters in a field path string that are reserved.
*/ var k = /* @__PURE__ */ new RegExp("[~\\*/\\[\\]]");
/**
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
	if (t.search(k) >= 0) throw __PRIVATE_createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, !1, void 0, r);
	try {
		return new FieldPath(...t.split("."))._internalPath;
	} catch (n) {
		throw __PRIVATE_createError(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, e, !1, void 0, r);
	}
}
...
*/ var DocumentSnapshot = class {
	...
	*/ data() {
		if (this._document) {
			if (this._converter) {
				const e = new QueryDocumentSnapshot(this._firestore, this._userDataWriter, this._key, this._document, null);
...
*/ var QueryFieldFilterConstraint = class QueryFieldFilterConstraint extends QueryConstraint {
	...
	*/
	...
	_parse(e) {
		...
		return function __PRIVATE_newQueryFilter(e, t, r, n, i, s, o) {
			let a;
			if (i.isKeyField()) {
			...
			} else "in" !== s && "not-in" !== s && "array-contains-any" !== s || __PRIVATE_validateDisjunctiveFilterElements(o, s), a = __PRIVATE_parseQueryValue(r, t, o, "in" === s || "not-in" === s);
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(e, t, r, n) {
	if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(e, t, r, n, i) {
		...
		const s = [];
		for (const r of __PRIVATE_queryNormalizedOrderBy(e)) if (r.field.isKeyField()) s.push(__PRIVATE_refValue(t, n.key));
		else {
...
*/ function __PRIVATE_validateNewFieldFilter(e, t) {
	...
	if (null !== r) throw r === t.op ? new FirestoreError(E.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${t.op.toString()}' filter.`) : new FirestoreError(E.INVALID_ARGUMENT, `Invalid query. You cannot use '${t.op.toString()}' filters with '${r.toString()}' filters.`);
}
...
*/ function getDocs(e) {
	...
	return __PRIVATE_invokeRunQueryRpc(t, e._query).then(((t) => {
		...
		return "L" === e._query.limitType && n.reverse(), new QuerySnapshot(e, n);
	}));
}
...
//#endregion
//#region node_modules/@firebase/firestore/dist/lite/index.browser.esm.js
var _t = "4.13.0";
/**
* @license
* Copyright 2017 Google LLC
...
var __PRIVATE_ExponentialBackoff = class {
	constructor(t, e, i = 1e3, r = 1.5, a = 6e4) {
		this.t = t, this.timerId = e, this.i = i, this.o = r, this.h = a, this.u = 0, this.l = null, this._ = Date.now(), this.reset();
	}
	/**
	...
	*/ A(t) {
		...
		r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${i} ms ago)`), this.l = this.t.enqueueAfterDelay(this.timerId, r, (() => (this._ = Date.now(), t()))), this.u *= this.o, this.u < this.i && (this.u = this.i), this.u > this.h && (this.u = this.h);
	}
	T() {
...
*/ var AggregateQuerySnapshot = class {
	/** @hideconstructor */
	constructor(t, e, i) {
		this._userDataWriter = e, this._data = i, this.type = "AggregateQuerySnapshot", this.query = t;
	}
	/**
...
*/ function getCount(t) {
	return getAggregate(t, { count: count() });
}
/**
...
*/ function getAggregate(t, e) {
	...
	return __PRIVATE_invokeRunAggregationQueryRpc(r, t._query, a).then(((e) => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, i) {
		return new AggregateQuerySnapshot(e, new __PRIVATE_LiteUserDataWriter(t), i);
	}(i, t, e)));
}
function sum(t) {
...
*/ var WriteBatch = class {
	...
	update(t, e, i, ...r) {
		...
		let o;
		return o = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", a._key, e, i, r) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", a._key, e), this._mutations.push(o.toMutation(a._key, Precondition.exists(!0))), this;
	}
	/**
...
*/ var Transaction$1 = class {
	constructor(t) {
		this.datastore = t, this.readVersions = /* @__PURE__ */ new Map(), this.mutations = [], this.committed = !1, this.lastTransactionError = null, this.writtenDocs = /* @__PURE__ */ new Set();
	}
	async lookup(t) {
	...
	recordVersion(t) {
		...
		if (t.isFoundDocument()) e = t.version;
			...
			if (!t.isNoDocument()) throw fail(50498, { R: t.constructor.name });
			e = SnapshotVersion.min();
		}
		const i = this.readVersions.get(t.key.toString());
		if (i) {
			if (!e.isEqual(i)) throw new FirestoreError(E.ABORTED, "Document version changed between two reads.");
	...
	*/ preconditionForUpdate(t) {
		...
		if (!this.writtenDocs.has(t.toString()) && e) {
			if (e.isEqual(SnapshotVersion.min())) throw new FirestoreError(E.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
...
var __PRIVATE_TransactionRunner = class {
	constructor(t, e, i, r, a) {
		this.asyncQueue = t, this.datastore = e, this.options = i, this.updateFunction = r, this.deferred = a, this.I = i.maxAttempts, this.P = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
	}
...
*/ var DelayedOperation = class DelayedOperation {
	constructor(t, e, i, r, a) {
		this.asyncQueue = t, this.timerId = e, this.targetTimeMs = i, this.op = r, this.removalCallback = a, this.deferred = new __PRIVATE_Deferred(), this.then = this.deferred.promise.then.bind(this.deferred.promise), this.deferred.promise.catch(((t) => {}));
	}
	get promise() {
	...
	*/ static createAndSchedule(t, e, i, r, a) {
		const h = new DelayedOperation(t, e, Date.now() + i, r, a);
		return h.start(i), h;
	}
	/**
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(t = Promise.resolve()) {
		this.k = [], this.q = !1, this.O = [], this.S = null, this.C = !1, this.M = !1, this.N = [], this.P = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.L = () => {
			const t = getDocument();
	...
	*/ enqueueAndForget(t) {
	...
	enqueue(t) {
		if (this.U(), this.q) return new Promise((() => {}));
	...
	*/ async j() {
		if (0 !== this.k.length) {
			...
			this.k.length > 0 && this.P.A((() => this.j()));
		}
	}
	$(t) {
		const e = this.W.then((() => (this.C = !0, t().catch(((t) => {
			this.S = t, this.C = !1;
			throw __PRIVATE_logError("INTERNAL UNHANDLED ERROR: ", __PRIVATE_getMessageOrStack(t)), t;
		})).then(((t) => (this.C = !1, t))))));
		return this.W = e, e;
	}
	enqueueAfterDelay(t, e, i) {
		this.U(), this.N.indexOf(t) > -1 && (e = 0);
		const r = DelayedOperation.createAndSchedule(this, t, e, i, ((t) => this.G(t)));
		return this.O.push(r), r;
	}
	U() {
		this.S && fail(47125, { H: __PRIVATE_getMessageOrStack(this.S) });
	}
...
*/ (function __PRIVATE_registerFirestore() {
	...
	}), "PUBLIC").setMultipleInstances(!0)), registerVersion("firestore-lite", _t, ""), registerVersion("firestore-lite", _t, "esm2020");
})();
//#endregion
